...
const Hero = () => {
  ...
  return <div ref={heroRef} className="relative pt-20 lg:pt-24 pb-12 lg:pb-16 overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="container relative px-4 mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-6 items-center">
          ...
          <div className="order-2 lg:order-1 animate-fade-up text-center lg:text-left mx-[25px]">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start py-0 px-[61px] mx-[11px] my-0">
