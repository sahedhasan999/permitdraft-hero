  ...
  return (
    <div className="h-full flex flex-col bg-white">
      ...
      <div 
        ...
        className={`flex-1 overflow-y-auto ${isMobile ? 'p-3 pb-4' : 'p-4 lg:p-6'} bg-gradient-to-b from-gray-50 to-gray-100`}
        style={isMobile ? {
      ...
      {activeConversation.status === 'active' && (
        <div className={`${isMobile ? 'p-3 sticky bottom-0' : 'p-4 lg:p-6'} border-t bg-white flex-shrink-0 shadow-lg`}>
